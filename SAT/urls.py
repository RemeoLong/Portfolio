...
urlpatterns = [
    ...
    path('/Test/<int:test_id>/Sections/<int:section_id>/Question/<int:question_id>/', views.detail, name='Question'),
    path('/Test/<int:test_id>/Sections/<int:section_id>/Questions/<int:question_id>/results/', views.result, name='results'),
    path('/Test/<int:test_id>/Sections/<int:section_id>/Questions/<int:question_id>/answer/', views.answer, name='answer'),
